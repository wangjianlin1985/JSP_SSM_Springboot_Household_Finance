...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">家庭收支管理网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="<%=basePath %>index.jsp">首页</a></li>
                 <li><a href="<%=basePath %>UserInfo/frontlist">家庭成员</a></li>
                <li><a href="<%=basePath %>IncomeType/frontlist">收入分类</a></li>
                <li><a href="<%=basePath %>Income/frontlist">收入记录</a></li>
                <li><a href="<%=basePath %>ExpendType/frontlist">支出分类</a></li>
                <li><a href="<%=basePath %>Expend/frontlist">支出查询</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>Income/income_frontUserAdd.jsp"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;登记收入</a></li>
                        <li><a href="<%=basePath %>Income/userFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我登记的收入</a></li>
                        <li><a href="<%=basePath %>Expend/expend_frontUserAdd.jsp"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;登记支出</a></li>
                        <li><a href="<%=basePath %>Expend/userFrontlist"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;我登记的支出</a></li>
                        <li><a href="<%=basePath %>UserInfo/userInfo_frontSelfModify.jsp"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;修改个人信息</a></li>
                    </ul>
                </li>
